<div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <a class="btn bg-gradient-dark w-100" href="#" target="_blank">Link</a>
            <a class="btn btn-outline-dark w-100" href="#" target="blank">Link</a>
            <div class="w-100 text-center">
                ...
                <a href="#" class="btn btn-dark mb-3 me-2" target="_blank">
