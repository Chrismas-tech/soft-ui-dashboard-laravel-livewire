<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Admin</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{-- {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }} --}}" href="#">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{-- {{ Route::currentRouteName() == 'billing' ? 'active' : '' }} --}}" href="#">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">
                    ...
                    <span class="nav-link-text ms-1">Unknown Route</span>
                </a>
            </li>
            <li class="nav-link mb-0">
                <a href="#" class="btn btn-primary btn-md active px-5 text-white" target="_blank"
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">Lorem Ipsum ?</h6>
                    <p class="text-xs font-weight-bold">Lorem ipsum dolor !</p>
                    <a href="#" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Link</a>
                </div>
            </div>
        </div>
    </div>
